...
export class HexTokenConfig extends FormApplication {
	...
	constructor(src, token, options = {}) {
		...
		this.object.data.tempHexValues.tempPivot = {
			x: this.object.document.getFlag("hex-size-support", "pivotx"),
			y: this.object.document.getFlag("hex-size-support", "pivoty"),
		};
	}
	...
	async getData(options) {
		return {
			...
			alternateOrientation: this.object.document.getFlag(
				"hex-size-support",
